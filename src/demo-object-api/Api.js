...
async function getServer() {
    ...
    // _ the hien tham so duoc khai bao nhung khong su dung 
    ...
    fastify.get('/6/method', { exposeAs: 'methodWithOptions' }, (req, reply) => {
        reply.send(`Hello from /6/method/ with query.arg ${req.query.arg
            } and the x-foobar header ${req.headers['x-foobar']
            }`)
    })
